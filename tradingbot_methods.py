...
from tradingbot_utils import format_currency, format_position
from tradingbot_ops import get_state
...
def test_model(agent, data, window_size):
    ...
    for t in range(data_length):
        ...
        # HOLD
            ...
            logging.debug("Holding... Not buying or selling")
